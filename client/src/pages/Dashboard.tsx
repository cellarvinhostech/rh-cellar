import { Users, Clock, CheckCircle, Building, Plus, Star, BarChart, UserPlus, Sparkles, Target, Calendar, MessageSquare, Gift, Coffee, Heart, ChevronLeft, ChevronRight, MapPin, CalendarDays, User, Send, MoreVertical } from "lucide-react";
...
export default function Dashboard() {
  ...
  const postLikes: Record<number, Array<{id: number; nome: string; avatar: string}>> = {
    1: [
  ...
  const postComments: Record<number, Array<{id: number; usuario: string; avatar: string; cargo: string; tempo: string; comentario: string}>> = {
    1: [
      {
        id: 1,
        ...
        tempo: "1 hora atrás",
        comentario: "Parabéns Ana! Esse módulo vai ser muito útil para nossa equipe. 👏"
      },
      {
        id: 2,
        ...
        comentario: "Incrível trabalho! Mal posso esperar para usar as novas funcionalidades."
      },
      {
        id: 3,
        usuario: "João Silva",
        ...
        comentario: "Ana, você poderia fazer uma apresentação sobre as tecnologias usadas? Seria ótimo para o time!"
      }
    ],
    23: [
      {
        ...
        cargo: "Tech Lead",
        tempo: "2 horas atrás",
        comentario: "Já confirmei minha presença! Será muito bom para desenvolver habilidades de liderança."
      },
      {
        id: 2,
    ...
    3: [
      ...
      },
      {
        ...
        comentario: "Parabéns a toda equipe de vendas! Inspirador ver esses resultados."
      },
      {
        id: 3,
        usuario: "João Silva",
    ...
    24: [
      ...
      },
      {
        ...
        cargo: "Gerente de Vendas",
        tempo: "3 horas atrás",
        comentario: "Será uma ótima oportunidade para conhecer os projetos de outras equipes."
      }
    ],
    25: [
      {
  ...
  const allTimelineData = [
    {
      ...
      cargo: "Desenvolvedora",
      tempo: "2 horas atrás",
      conteudo: "Acabei de finalizar o novo módulo de relatórios! 🎉 Foi um desafio interessante trabalhar com as novas tecnologias. Obrigada ao time pelo apoio!",
      likes: 12,
      comentarios: 3,
      imagem: null
    },
    {
      ...
      eventoData: {
        ...
        participantes: 25,
        tipo: "workshop",
        descricao: "Desenvolva suas habilidades de liderança com especialistas da área. Workshop interativo com casos práticos e dinâmicas em grupo.",
    ...
    },
    {
      ...
      cargo: "Recursos Humanos",
      tempo: "4 horas atrás",
      conteudo: "📢 Lembrando que hoje é o último dia para participar da pesquisa de clima organizacional. Sua opinião é muito importante para nós!",
      likes: 8,
      comentarios: 1,
      imagem: null
    },
    {
      ...
      eventoData: {
        ...
        participantes: 40,
        tipo: "apresentacao",
        descricao: "Venha conhecer os projetos incríveis que foram desenvolvidos neste trimestre. Apresentações de 15 minutos por equipe.",
    ...
    },
    {
      ...
      cargo: "Gerente de Vendas",
      tempo: "1 dia atrás",
      conteudo: "🎯 Meta do trimestre batida! Parabéns a toda equipe de vendas pelo excelente trabalho. Vamos celebrar na sexta-feira!",
      likes: 25,
      comentarios: 8,
      imagem: null
    },
    {
      ...
      eventoData: {
        ...
        participantes: 15,
        tipo: "wellness",
        descricao: "Sessão guiada de mindfulness para reduzir o estresse e melhorar o foco. Traga roupas confortáveis.",
    ...
    },
    {
      ...
      cargo: "Sistema",
      tempo: "2 dias atrás",
      conteudo: "👋 Damos as boas-vindas à Maria Santos, que se juntou ao nosso time de Design! Estamos animados para trabalhar junto com você.",
      likes: 15,
      comentarios: 5,
      imagem: null
    },
    {
      ...
      cargo: "Analista de RH",
      tempo: "2 dias atrás",
      conteudo: "🗓️ Lembrete: amanhã teremos o workshop de liderança às 14h no auditório principal. Não esqueçam de confirmar presença!",
      likes: 18,
      comentarios: 4,
      imagem: null
    },
    {
      ...
      cargo: "Designer",
      tempo: "3 dias atrás",
      conteudo: "✨ Muito feliz em receber o feedback positivo do cliente sobre o novo design! Trabalho em equipe sempre rende os melhores frutos. 💪",
      likes: 22,
      comentarios: 7,
      imagem: null
    },
    {
      ...
      eventoData: {
        ...
        participantes: 60,
        tipo: "celebracao",
        descricao: "Vamos celebrar juntos o sucesso do terceiro trimestre! Haverá comida, bebidas e muita diversão.",
    ...
    },
    {
      ...
      cargo: "Tech Lead",
      tempo: "3 dias atrás",
      conteudo: "💡 Dica do dia: sempre façam code review com carinho! É uma oportunidade de aprender e ensinar ao mesmo tempo. #DevLife",
      likes: 14,
      comentarios: 6,
      imagem: null
    },
    {
      ...
      cargo: "Sistema",
      tempo: "4 dias atrás",
      conteudo: "🎂 Hoje é aniversário da nossa querida Fernanda Lima! Desejamos muito sucesso e felicidades. Parabéns! 🎉",
      likes: 31,
      comentarios: 12,
      imagem: null
    },
    {
      ...
      cargo: "Product Manager",
      tempo: "4 dias atrás",
      conteudo: "🚀 Lançamos a nova funcionalidade de integração com APIs externas! Os usuários já estão adorando. Obrigado a todos os envolvidos!",
      likes: 19,
      comentarios: 5,
      imagem: null
    },
    {
      ...
      tempo: "5 dias atrás",
      conteudo: "📚 Inscrições abertas para o curso de Excel Avançado! Vagas limitadas. Interessados podem se inscrever até sexta-feira.",
      likes: 16,
      comentarios: 9,
      imagem: null
    },
    {
      ...
      tempo: "5 dias atrás",
      conteudo: "🌱 Nossa empresa plantou mais 100 árvores este mês! Juntos estamos construindo um futuro mais sustentável. #MeioAmbiente",
      likes: 27,
      comentarios: 8,
      imagem: null
    },
    {
      ...
      tempo: "6 dias atrás",
      conteudo: "⚡ Deploy automático implementado com sucesso! Agora os releases são 3x mais rápidos. Produtividade em alta! 🔥",
      likes: 21,
      comentarios: 4,
      imagem: null
    },
    {
      ...
      tempo: "6 dias atrás",
      conteudo: "🤝 Fechamos mais um contrato importante! Cliente super satisfeito com nosso atendimento. Equipe de vendas arrasando!",
      likes: 24,
      comentarios: 6,
      imagem: null
    },
    {
      ...
      conteudo: "🧘‍♀️ Lembrete: cuidar da saúde mental é essencial! Nossa sala de relaxamento está sempre disponível para vocês.",
      likes: 20,
      comentarios: 11,
      imagem: null
    },
    {
      ...
      cargo: "Scrum Master",
      tempo: "1 semana atrás",
      conteudo: "🎯 Sprint finalizada com 100% das tasks concluídas! Parabéns time, vocês são incríveis. Próxima planning na segunda!",
      likes: 17,
      comentarios: 3,
      imagem: null
    },
    {
      ...
      tempo: "1 semana atrás",
      conteudo: "📈 Participamos do maior evento de tecnologia do ano! Muitos contatos interessantes e oportunidades de parcerias.",
      likes: 23,
      comentarios: 7,
      imagem: null
    },
    {
      ...
      tempo: "1 semana atrás",
      conteudo: "✅ Implementamos o novo processo de QA! Diminuímos os bugs em produção em 40%. Qualidade em primeiro lugar!",
      likes: 19,
      comentarios: 5,
      imagem: null
    },
    {
      ...
      cargo: "Recursos Humanos",
      tempo: "1 semana atrás",
      conteudo: "🌈 Orgulhosos de ser uma empresa diversa e inclusiva! 45% do nosso time é composto por mulheres. Vamos continuar crescendo juntos!",
      likes: 35,
      comentarios: 14,
      imagem: null
    },
    {
      ...
      tempo: "1 semana atrás",
      conteudo: "🎓 Finalizei mais uma certificação! Aprender nunca é demais. Quem mais está estudando algo novo? Vamos trocar conhecimentos!",
      likes: 18,
      comentarios: 8,
      imagem: null
    },
    {
      ...
      conteudo: "💪 Começamos o mês com energia total! Grandes projetos pela frente e tenho certeza que vamos superar todas as expectativas. Juntos somos mais fortes!",
      likes: 42,
      comentarios: 16,
      imagem: null
    },
    {
      ...
      tempo: "2 semanas atrás",
      conteudo: "📊 Relatório mensal finalizado! Crescimento de 15% em relação ao mês anterior. Números que motivam a continuar trabalhando duro!",
      likes: 26,
      comentarios: 5,
      imagem: null
    },
    {
      ...
      tempo: "2 semanas atrás",
      conteudo: "🎪 Que tal um happy hour virtual na sexta? Vamos relaxar e nos conectar! Quem topa? Link será enviado por email.",
      likes: 29,
      comentarios: 13,
      imagem: null
    }
  ...
  const enquetesAtivas = enquetesData.filter(enquete => enquete.status === 'ativa').length;
              ...
              <div className="flex-1 min-w-0">
                <div className="bg-gray-50 rounded-lg px-3 py-2">
                  <div className="flex items-center space-x-2 mb-1">
                    <h5 className="font-medium text-gray-900 text-sm">{comment.usuario}</h5>
                    <span className="text-xs text-gray-500">•</span>
                    <span className="text-xs text-gray-500">{comment.cargo}</span>
                  </div>
    ...
    return (
      <div className="absolute top-full left-0 mt-2 bg-white rounded-lg shadow-lg border border-gray-200 p-3 z-10 min-w-[250px]">
        <div className="flex items-center justify-between mb-3">
          <h4 className="font-medium text-gray-900 text-sm">Curtidas ({likes.length})</h4>
          <button 
          ...
          {likes.map((like) => (
            <div key={like.id} className="flex items-center space-x-2">
              <div className="w-6 h-6 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center">
                <span className="text-white text-xs font-medium">{like.avatar}</span>
              </div>
  ...
  const renderEventPost = (item: any) => {
    ...
    const getStatusColor = (status: string) => {
      switch (status) {
        ...
        case 'vagas-limitadas': return 'bg-orange-100 text-orange-600 border-orange-200';
    ...
    const getStatusText = (status: string) => {
      switch (status) {
        ...
        case 'vagas-limitadas': return 'Vagas Limitadas';
    ...
    return (
      <div key={item.id} className="bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-200 rounded-xl p-6">
        {/* Header do Post */}
        <div className="flex items-center space-x-3 mb-4">
          <div className="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center">
            <span className="text-white text-sm font-medium">{item.avatar}</span>
          </div>
          <div className="flex-1">
            <h4 className="font-medium text-gray-900">{item.usuario}</h4>
            <p className="text-xs text-gray-500">{item.cargo} • {item.tempo}</p>
          </div>
        ...
        <div className="bg-white rounded-lg border border-purple-200 p-4 mb-4">
          <div className="flex items-start justify-between mb-3">
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-gray-900 mb-1">{eventoData.titulo}</h3>
              <p className="text-sm text-gray-600">{eventoData.descricao}</p>
            </div>
            <div className={`px-2 py-1 rounded-full text-xs font-medium border ${getStatusColor(eventoData.status)}`}>
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="px-4 py-2 bg-purple-600 text-white text-sm rounded-lg hover:bg-purple-700 transition-colors">
              {eventoData.status === 'vagas-limitadas' ? 'Garantir Vaga' : 'Participar'}
            </button>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between pt-3 border-t border-purple-100">
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              >
                <Heart className={`w-4 h-4 ${likedPosts[item.id] ? 'fill-current' : ''}`} />
                <span className="text-sm">{item.likes + (likedPosts[item.id] ? 1 : 0)}</span>
              </button>
            ...
            {currentPosts.map((item) => {
              ...
              return (
                <div key={item.id} className="bg-white border border-gray-200 rounded-lg p-4">
                  ...
                  {/* Conteúdo do Post */}
                  <div className="mb-4">
                    <p className="text-gray-800 leading-relaxed">{item.conteudo}</p>
                  </div>
            ...
            {hasMorePosts && (
              <div className="text-center py-6">
                ...
                <p className="text-xs text-gray-400 mt-2">
                  Mostrando {visiblePosts} de {allTimelineData.length} posts • Role para baixo para carregar automaticamente
                </p>
              </div>
            )}
              ...
              <div key={item.id} className="p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className={`px-2 py-1 text-xs rounded-full ${
                    item.status === 'ativa' ? 'bg-green-100 text-green-600' : 'bg-gray-100 text-gray-600'
                  }`}>
                    {item.status}
                  </span>
                </div>
                ...
                <div className="flex items-center text-xs text-gray-500">
                  <span>{item.participantes}/{item.total} participantes</span>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm sm:text-base">Seu Feed de informações e interações</p>
              </div>
            </div>
          </div>
        </header>
                  ...
                  <div className="p-6">
                    {activeTab === "timeline" && currentPosts.length === 0 ? (
                      <div className="text-center py-12">
                        ...
                        <p className="text-gray-500 text-lg font-medium">Nenhuma publicação foi feita</p>
                      </div>
                    ) : (
                      renderTabContent()
                    )}
              ...
              <div className="lg:col-span-1">
                <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
                  ...
                  {aniversariantes.length === 0 ? (
                    <p className="text-gray-500 text-center py-8">Nenhuma aniversariante ativa</p>
                  ) : (
                    <div className="space-y-4">
                      {aniversariantes.map((pessoa) => (
                        <div key={pessoa.id} className="flex items-center space-x-3">
                          <div className="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center">
                            <span className="text-white text-sm font-medium">{pessoa.avatar}</span>
                          </div>
                          <div className="flex-1 min-w-0">
                            <p className="text-sm font-medium text-gray-900 truncate">{pessoa.nome}</p>
                            <p className="text-xs text-gray-500">{pessoa.cargo}</p>
                            <p className="text-xs text-purple-600 font-medium">{pessoa.data}</p>
                          </div>
                          {pessoa.data === "Hoje" && (
