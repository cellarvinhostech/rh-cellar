        ...
        <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
          ...
          {selectedEmployee && (
            <>
              ...
              {/* Details Panel */}
              <div className="fixed inset-x-0 bottom-16 top-1/4 lg:relative lg:inset-auto lg:w-1/2 lg:h-full overflow-auto bg-white lg:bg-slate-50 z-50 lg:z-auto rounded-t-xl lg:rounded-none p-4 sm:p-6">
